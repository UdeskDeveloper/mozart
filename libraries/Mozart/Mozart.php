 ...
 *
 * Generally, code in Mozart should accept its dependencies via either
 ...
 * \Mozart\Core\CoreServiceProvider, the service providers of enabled modules and any other
 ...
 *   function hook_do_stuff() {
 *     $lock = \Mozart::lock()->acquire('stuff_lock');
 *     // ...
 *   }
 *
 ...
 *     $instance = new StuffDoingClass(\Mozart::lock());
 *     $instance->doStuff();
 *
 ...
 *     // practice.
 *     \Mozart::service('stuff.doing')->doStuff();
 *   }
 *
...
class Mozart
{
   ...
   *
   * @return \Mozart\Core\Session\AccountProxyInterface
   */
   ...
   *
   * @return \Mozart\Core\Entity\EntityManagerInterface
   ...
   *
   * @return \Mozart\Core\Database\Connection
   ...
   *   defaults to 'default'.
   *
   * @return \Mozart\Core\Cache\CacheBackendInterface
   ...
   *
   * @return \Mozart\Core\KeyValueStore\KeyValueStoreExpirableInterface
   ...
   *
   * @return \Mozart\Core\Lock\LockBackendInterface
   *
   * @ingroup lock
   */
   ...
   *
   * @return \Mozart\Core\Config\Config
   ...
   * or off.
   *
   * @return \Mozart\Core\Config\ConfigFactoryInterface
   ...
   *
   * @return \Mozart\Core\Queue\QueueInterface
   ...
   *
   * @return \Mozart\Core\KeyValueStore\KeyValueStoreInterface
   */
   ...
   * (for example, the system maintenance message) should use \Mozart::config() instead.
   *
   * @return \Mozart\Core\KeyValueStore\StateInterface
   */
   ...
   *
   * @return \Mozart\Core\Entity\Query\QueryInterface
   ...
   *   enough. Optional, defaults to AND.
   *
   * @return \Mozart\Core\Entity\Query\QueryAggregateInterface
   *   The query object that can query the given entity type.
   */
   ...
   *
   * @return \Mozart\Core\Flood\FloodInterface
   */
   ...
   *
   * @return \Mozart\Core\Extension\ModuleHandlerInterface
   */
   ...
   *
   * @return \Mozart\Core\TypedData\TypedDataManager
   *   The typed data manager.
   *
   * @see \Mozart\Core\TypedData\TypedDataManager::create()
   */
   ...
   *
   * @return \Mozart\Core\Utility\Token
   *   The token service.
   */
   ...
   *
   * @return \Mozart\Core\Routing\UrlGeneratorInterface
   ...
   *     obtained from \Mozart::languageManager()->getCurrentLanguage(Language::TYPE_URL).
   ...
   *
   * @see \Mozart\Core\Routing\UrlGeneratorInterface::generateFromRoute()
   */
   ...
   *
   * @return \Mozart\Core\Utility\LinkGeneratorInterface
   */
   ...
   * @code
   * t('Visit the <a href="@url">content types</a> page', array('@url' => \Mozart::url('node.overview_types')));
   * @endcode
   ...
   *     Mozart\Core\Template\Attribute($options['attributes']).
   ...
   *
   * @see \Mozart\Core\Routing\UrlGeneratorInterface::generateFromRoute()
   * @see \Mozart\Core\Utility\LinkGeneratorInterface::generate()
   */
   ...
   *
   * @return \Mozart\Core\StringTranslation\TranslationManager
   ...
   *
   * @return \Mozart\Core\Language\LanguageManagerInterface
   ...
   *
   * @return \Mozart\Core\Access\CsrfTokenGenerator
   *   The CSRF token manager.
   *
   * @see \Mozart\Core\Session\SessionManager::start()
   */
   ...
   *
   * @return \Mozart\Core\Transliteration\PHPTransliteration
   ...
   *
   * @return \Mozart\Core\Form\FormBuilderInterface
   *   The form builder.
   */
