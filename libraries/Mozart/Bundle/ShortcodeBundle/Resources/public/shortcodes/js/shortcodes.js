(function () {
	tinymce.create('tinymce.plugins.mozart', {
		/**
		...
		init: function (ed, url) {
			...
			ed.addButton('faq', {title: 'FAQ', cmd: 'faq', image: url + '/../img/faq.png' });
			ed.addCommand('faq', function () {
				ed.execCommand('mceInsertContent', 0, '[faq category="ID"][/faq]');
			});

			ed.addButton('pricing', {title: 'Pricing', cmd: 'pricing', image: url + '/../img/pricing.png' });
	...
	// Register plugin
	tinymce.PluginManager.add('mozart', tinymce.plugins.mozart);
})();