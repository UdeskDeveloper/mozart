...
class FeaturedProperties extends \WP_Widget
{
    public function __construct()
    {
        parent::__construct(
                'FeaturedProperties_Widget', __('Rhetina: Featured Properties', 'mozart'), array(
            'classname' => 'properties',
            'description' => __('Featured Properties', 'mozart'),
        ));
    }
    ...
    public function widget($args, $instance)
    {
        ...
        twiggy('PropertyBundle:Property:widget.html.twig', array(
            ...
            'count' => $instance['count'],
            'properties' => \Mozart::service('realestate.property.model')->get_featured($instance['count'], $do_shuffle),
