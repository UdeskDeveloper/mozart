...
class MostRecentProperties extends \WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            'MostRecentProperties_Widget',
            __( 'Rhetina: Most Recent Properties', 'mozart' ),
            array(
                'classname'   => 'properties',
                'description' => __( 'Most Recent Properties', 'mozart' ),
            ) );
    }
    ...
    public function form($instance)
    {
        if ( isset( $instance['title'] ) ) {
            ...
            $title = __( 'Most Recent Properties', 'mozart' );
        }
    ...
    public function widget($args, $instance)
    {
        ...
        twiggy( 'PropertyBundle:Property:widget.html.twig', array(
            ...
            'count'         => $instance['count'],
            'properties'    => \Mozart::service('realestate.property.model')->get_most_recent( $instance['count'], $do_shuffle ),
