...
class Tracker
{
    ...
    function tracking_request()
    {
        ...
        $this->print_scripts(
            $id,
            $opt_arr,
            __( 'Do not allow tracking', 'redux-framework' ),
            $button2,
            $function2,
            $function1
        );
    ...
    function newsletter_request()
    {
        ...
        $content .= '<p><strong>' . __( 'Getting Started', 'redux-framework' ) . '</strong><br>' . sprintf(
                __(
                    'This panel demonstrates the many features of Redux.  Before digging in, we suggest you get up to speed by reviewing %1$s.',
                    'redux-framework'
                ),
                '<a href="http://docs.reduxframework.com/redux-framework/getting-started/" target="_blank">' . __(
                    'our documentation',
                    'redux-framework'
                ) . '</a>'
            );
        $content .= '<p><strong>' . __( 'Redux Generator', 'redux-framework' ) . '</strong><br>' . sprintf(
                __(
        ...
        $content .= '<p><strong>' . __( 'Redux Extensions', 'redux-framework' ) . '</strong><br>' . sprintf(
                __(
        ...
        $content .= '<p><strong>' . __( 'Like Redux?', 'redux-framework' ) . '</strong><br>' . sprintf(
                __(
                    'If so, please %1$s and consider making a %2$s to keep development of Redux moving forward.',
                    'redux-framework'
                ),
                '<a target="_blank" href="http://wordpress.org/support/view/plugin-reviews/redux-framework">' . __(
        ...
        $content .= '<p><strong>' . __( 'Newsletter', 'redux-framework' ) . '</strong><br>' . __(
