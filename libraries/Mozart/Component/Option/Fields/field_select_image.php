        ...
        class ReduxFramework_select_image
        {
            ...
            function enqueue()
            {
                wp_enqueue_script(
                    ...
                    ReduxFramework::$_url . 'src/fields/select_image/field_select_image' . Redux_Functions::isMin() . '.js',
                ...
                wp_enqueue_style(
                    ...
                    ReduxFramework::$_url . 'src/fields/select_image/field_select_image.css',
                    time(),
                    true
                );
            } //function
