        ...
        class ReduxFramework_group
        {
            ...
            public function enqueue()
            {
                wp_enqueue_script(
                    ...
                    ReduxFramework::$_url . 'src/fields/group/field_group.js',
                ...
                wp_enqueue_style(
                    ...
                    ReduxFramework::$_url . 'src/fields/group/field_group.css',
                    time(),
                    true
                );
            }
            ...
            public function enqueue_dependencies($field_type)
            {
                ...
                if ( ! class_exists( $field_class ) ) {
                    $class_file = apply_filters( 'redux-typeclass-load', ReduxFramework::$_dir . 'src/fields/' . $field_type . '/field_' . $field_type . '.php', $field_class );
