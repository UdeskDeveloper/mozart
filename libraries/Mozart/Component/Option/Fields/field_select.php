    ...
    if ( ! class_exists( 'ReduxFramework_select' ) ) {
        class ReduxFramework_select
        {
            ...
            function render()
            {
                ...
                if ( ! empty( $this->field['data'] ) && empty( $this->field['options'] ) ) {
                    ...
                    if ($this->field['data'] == "elusive-icons" || $this->field['data'] == "elusive-icon" || $this->field['data'] == "elusive") {
                        $icons_file = ReduxFramework::$_dir . 'src/fields/select/elusive-icons.php';
                        /**
            ...
            function enqueue()
            {
                wp_enqueue_script(
                    'field-select-js',
                    ReduxFramework::$_url . 'src/fields/select/field_select' . Redux_Functions::isMin() . '.js',
                ...
                wp_enqueue_style(
                    ...
                    ReduxFramework::$_url . 'src/fields/select/field_select.css',
                    time(),
                    true
                );
            } //function
