    ...
    if ( ! class_exists( 'ReduxFramework_ace_editor' ) ) {
        class ReduxFramework_ace_editor
        {
            ...
            public function enqueue()
            {
                wp_enqueue_script(
                    'ace-editor-js',
                    ReduxFramework::$_url . 'src/fields/ace_editor/vendor/ace.js',
                    array( 'jquery' ),
                    filemtime( ReduxFramework::$_dir . 'src/fields/ace_editor/vendor/ace.js' ),
                    true
                );

                wp_enqueue_style(
                    'redux-field-ace-editor-css',
                    ReduxFramework::$_url . 'src/fields/ace_editor/field_ace_editor.css',
                    time(),
                    true
                );
                ...
                wp_enqueue_script(
                    ...
                    ReduxFramework::$_url . 'src/fields/ace_editor/field_ace_editor' . Redux_Functions::isMin() . '.js',
