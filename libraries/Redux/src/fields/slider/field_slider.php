    ...
    if ( ! class_exists( 'ReduxFramework_slider' ) ) {
        class ReduxFramework_slider
        {
            ...
            function enqueue()
            {
                ...
                wp_enqueue_style(
                    'nouislider-css',
                    ReduxFramework::$_url . 'src/fields/slider/vendor/nouislider/jquery.nouislider.css',
                    array(),
                    filemtime( ReduxFramework::$_dir . 'src/fields/slider/vendor/nouislider/jquery.nouislider.css' ),
                    'all'
                );

                wp_register_script(
                    'nouislider-js',
                    ReduxFramework::$_url . 'src/fields/slider/vendor/nouislider/jquery.nouislider' . $min . '.js',
                    array( 'jquery' ),
                    '5.0.0',
                    true
                );
                ...
                wp_enqueue_script(
                    ...
                    ReduxFramework::$_url . 'src/fields/slider/field_slider' . $min . '.js',
                ...
                wp_enqueue_style(
                    ...
                    ReduxFramework::$_url . 'src/fields/slider/field_slider.css',
                    time(),
                    true
                );
            }
