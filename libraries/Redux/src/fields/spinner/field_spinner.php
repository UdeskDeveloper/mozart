        ...
        class ReduxFramework_spinner
        {
            ...
            function enqueue()
            {
                wp_enqueue_script(
                    ...
                    ReduxFramework::$_url . 'src/fields/spinner/vendor/spinner_custom.js',
                    array( 'jquery' ),
                    time(),
                    true
                );
                ...
                wp_enqueue_script(
                    ...
                    ReduxFramework::$_url . 'src/fields/spinner/field_spinner' . Redux_Functions::isMin() . '.js',
                    array(
                        'jquery',
                        'redux-field-spinner-custom-js',
                        'jquery-ui-core',
                ...
                wp_enqueue_style(
                    ...
                    ReduxFramework::$_url . 'src/fields/spinner/field_spinner.css',
                    time(),
                    true
                );
            }
