	...
	class VC_Extensions_AnimateText
	{
		function VC_Extensions_AnimateText()
		{
				...
				array(
					...
					"params"      => array(
						...
						array(
							...
							'value'       => array(
								__( "Same window", "vc_animatetext_cq" ) => "_self",
								__( "New window", "vc_animatetext_cq" )  => "_blank"
							)
						),
						array(
							"type"        => "textfield",
							...
							"description" => __(
								"Default is sup, you can use other tag like span, sub here too.",
								'vc_animatetext_cq'
							)
						),
						array(
						...
						array(
							...
							"value"       => array(
								__( "animation 1", "vc_animatetext_cq" ) => "animation-01",
								__( "animation 2", "vc_animatetext_cq" ) => "animation-02",
								__( "animation 3", "vc_animatetext_cq" ) => "animation-03",
								__( "animation 4", "vc_animatetext_cq" ) => "animation-04",
								__( "animation 5", "vc_animatetext_cq" ) => "animation-05",
								__( "animation 6", "vc_animatetext_cq" ) => "animation-06",
								__( "animation 7", "vc_animatetext_cq" ) => "animation-07",
								__( "animation 8", "vc_animatetext_cq" ) => "animation-08",
								__( "animation 9", "vc_animatetext_cq" ) => "animation-09"
							),
							"description" => __( "", "vc_animatetext_cq" )
						),
						array(
							...
							"description" => __(
								"Defautl the animate text will append to the end, check this if you want to put it in the start.",
								'vc_animatetext_cq'
							)
						)
			...
			function cq_vc_animatetext_func($atts, $content = null)
			{
				...
				wp_register_script(
					'vc_animatetext_cq_script',
					plugins_url( 'js/animatetext.min.js', __FILE__ ),
					array( "jquery" )
				);
				...
				if ($link != "") {
					...
					if ($animation == "animation-02" || $animation == "animation-03") {
						...
						if ($animation == "animation-08" || $animation == "animation-09" || $animation == "animation-04") {
							$splittext .= '<span>';
							$splittext .= $text;
							$splittext .= '</span>';
						} else {
